...
import 'package:tbcare_main/core/location_service.dart';
...
class _SignUpScreenState extends State<SignUpScreen> with TickerProviderStateMixin {
  ...
  Future<void> _handleSignUp() async {
    ...
    final error = await _authService.signUp(
      ...
      status: "Active",
      flagged: false,
      detectedCity: _detectedCity, // ✅ Pass detected city
    );
  ...
  String? _validateEmail(String? value) {
    ...
    const blacklistedUsernames = [
      ...
      'welcome', 'mail', 'email', 'contact', 'support',
      ...
      'tbcareai', 'doctor', 'patient', 'chw', 'nurse', 'staff',
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    // Role Field (read-only, auto-set to CHW)
                    _buildRoleField(),
                    const SizedBox(height: 30),
